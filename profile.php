...
<div class="container-fluid mt--7" id="updateform" style="display:none;">
      <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="update-email" name="update-email"class="form-control form-control-alternative" placeholder="<?php echo $rows['email'];?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="<?php echo $rows['name'];?>" value="Lucky">
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control form-control-alternative" placeholder="<?php echo $rows['address'];?>" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
    ...
    <div class="container-fluid mt--7" id="normalform">
      <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" disabled="disabled">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-last-name" class="form-control form-control-alternative" placeholder="<?php echo $rows['name'];?>">
                      </div>
                    </div>
                  </div>
                </div>
